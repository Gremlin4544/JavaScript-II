...
firstNameAllCaps = runners.map(function(runners){
  return firstNamesAllCaps.push(`${runners.first_name}`);
});
console.log(firstNameAllCaps.toUpperCase);
...
let smallShirt = runners.filter(small =>
  small.shirt_size === "S"
